...
inline fun compare(a: Quaternion, b: Float, eps: Float? = null) = compare(a.xyzw, b, eps)
inline fun compare(a: Quaternion, b: Quaternion, eps: Float? = null) = compare(a.xyzw, b.xyzw, eps)
inline fun lessThan(a: Quaternion, b: Float, eps: Float? = null) = lessThan(a.xyzw, b, eps)
inline fun lessThan(a: Quaternion, b: Quaternion, eps: Float? = null) = lessThan(a.xyzw, b.xyzw, eps)
inline fun lessThanEqual(a: Quaternion, b: Float, eps: Float? = null) = lessThanEqual(a.xyzw, b, eps)
inline fun lessThanEqual(a: Quaternion, b: Quaternion, eps: Float? = null) = lessThanEqual(a.xyzw, b.xyzw, eps)
inline fun greaterThan(a: Quaternion, b: Float, eps: Float? = null) = greaterThan(a.xyzw, b, eps)
inline fun greaterThan(a: Quaternion, b: Quaternion, eps: Float? = null) = greaterThan(a.xyzw, b.xyzw, eps)
inline fun greaterThanEqual(a: Quaternion, b: Float, eps: Float? = null) = greaterThanEqual(a.xyzw, b, eps)
inline fun greaterThanEqual(a: Quaternion, b: Quaternion, eps: Float? = null) = greaterThanEqual(a.xyzw, b.xyzw, eps)
inline fun equal(a: Quaternion, b: Float, eps: Float? = null) = equal(a.xyzw, b, eps)
inline fun equal(a: Quaternion, b: Quaternion, eps: Float? = null) = equal(a.xyzw, b.xyzw, eps)
inline fun notEqual(a: Quaternion, b: Float, eps: Float? = null) = notEqual(a.xyzw, b, eps)
inline fun notEqual(a: Quaternion, b: Quaternion, eps: Float? = null) = notEqual(a.xyzw, b.xyzw, eps)
inline fun equals(a: Quaternion, b: Float, eps: Float? = null) = equals(a.xyzw, b, eps)
inline fun equals(a: Quaternion, b: Quaternion, eps: Float? = null) = equals(a.xyzw, b.xyzw, eps)
